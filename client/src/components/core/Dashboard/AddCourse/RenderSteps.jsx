...
const RenderSteps = () => {
  ...
  return (
    <>
                    ...
                    {steps.map( (item) => (
                        <div key={item.id} className=' flex w-full justify-between'>
                            <div className='flex flex-col items-center'>
                                ...
                                {
                                    //it show all step that mark or done
                                    step > item.id ? (<FaCheck className='text-yellow-25'/>) :(item.id)
                                }
                                </div>
                            </div>

                            {
                                //it show dashed line between steps;
                                item.id <3 && (
        ...
        {/* Asccording step show course filling details */}
