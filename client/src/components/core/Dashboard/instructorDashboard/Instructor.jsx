...
import { getInstructorData } from '../../../../services/operations/EnrolledCoursesAPI';
import InstructorChart from './InstructorCharts';
...
export default function Instructor() {
  ...
  return (
    <div className="space-y-4 w-10/12 mb-[4rem]">
