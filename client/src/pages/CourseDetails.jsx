                    ...
                    <div className='flex flex-col gap-4 rounded-md bg-richblack-700 p-4 text-richblack-5'>
                        ...
                        <div className='px-4'>
                            ...
                            <div className='flex flex-col gap-4'>
                                ...
                                <>
                                {
                                    alreadyEnrolled ? <button onClick={()=>{navigate("/dashboard/enrolled-courses")}} className='bg-yellow-25 text-black'>Go to Course</button> : <button onClick={handelPayment} className='bg-yellow-25 text-black rounded-lg text-2xl'>Buy Now</button>
                                }
                                {
                                alreadyEnrolled ? (<div></div>) : 
                                (
                                    cart?.find((item) => item._id === courseDetail._id) ?
                                    (<button onClick={()=>{navigate("/dashboard/cart")}} className='bg-richblack-800 text-richblack-5 rounded-lg'>Go to Cart</button>) :
                                    (<button onClick={handelAddToCart} className='bg-richblack-800 text-richblack-5 rounded-lg'>Add to Cart</button>)
                                )
                            }
                                </>
                                }
